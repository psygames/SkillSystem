    ...
    public static class MathUtils
    {
        ...
        public static Matrix2x2 MulT(in Matrix2x2 a, in Matrix2x2 b)
        {
            return new Matrix2x2(
                new FVector2(FVector2.Dot(a.Ex, b.Ex), FVector2.Dot(a.Ey, b.Ex)),
                new FVector2(FVector2.Dot(a.Ex, b.Ey), FVector2.Dot(a.Ey, b.Ey)));
        }
        ...
        public static FVector2 MulT(in Transform T, in FVector2 v)
        {
            ...
            return new FVector2(T.Rotation.Cos * px + T.Rotation.Sin * py, -T.Rotation.Sin * px + T.Rotation.Cos * py);
        }
